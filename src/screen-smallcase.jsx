  ...
  if (!_demo) {
    return (
      <div style={{ padding: 24, maxWidth: 720, margin: '40px auto', textAlign: 'center' }}>
        <div style={{ fontSize: 12, color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: 0.6 }}>Smallcase baskets</div>
        ...
        <div style={{ fontSize: 13, color: 'var(--text-2)', marginTop: 8, lineHeight: 1.5 }}>
          This screen does not yet have a real backend wired. Until smallcase baskets data is sourced from live broker / partner APIs, showing hardcoded sample data is misleading and unsafe.
